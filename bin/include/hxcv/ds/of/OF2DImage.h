...
#define INCLUDED_hxcv_ds_of_OF2DImage
...
HX_DECLARE_CLASS3(hxcv,ds,of,OF2DImage)
...
class OF2DImage_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef OF2DImage_obj OBJ_;
		OF2DImage_obj();
		Void __construct(::of::graphics::Image img);

	public:
		static hx::ObjectPtr< OF2DImage_obj > __new(::of::graphics::Image img);
		...
		inline operator ::hxcv::ds::I2DImage_obj *()
			{ return new ::hxcv::ds::I2DImage_delegate_< OF2DImage_obj >(this); }
		hx::Object *__ToInterface(const type_info &inType);
		::String __ToString() const { return HX_CSTRING("OF2DImage"); }
...
#endif /* INCLUDED_hxcv_ds_of_OF2DImage */ 
