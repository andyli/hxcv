...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/StringBuf.hx",37)
...
Void StringBuf_obj::add( Dynamic x){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/StringBuf.hx",48)
...
Void StringBuf_obj::addSub( ::String s,int pos,Dynamic len){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/StringBuf.hx",64)
