...
bool Reflect_obj::hasField( Dynamic o,::String field){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Reflect.hx",30)
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Reflect.hx",34)
...
Void Reflect_obj::setField( Dynamic o,::String field,Dynamic value){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Reflect.hx",38)
		if ((o != null())){
...
bool Reflect_obj::isFunction( Dynamic f){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Reflect.hx",57)
