...
::Class Type_obj::getSuperClass( ::Class c){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",57)
	return c->GetSuper();
}
...
::String Type_obj::getEnumName( ::Enum e){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",67)
	return e->__ToString();
}
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",91)
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",107)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",111)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",115)
...
::ValueType Type_obj::_typeof( Dynamic v){
	...
	if (  ( _switch_2==::vtBool)){
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",130)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",135)
	return (a == b);
}
...
::String Type_obj::enumConstructor( Dynamic e){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",139)
	return e->__Tag();
}
...
int Type_obj::enumIndex( Dynamic e){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",148)
	return e->__Index();
}
