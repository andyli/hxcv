...
{
{
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",30)
...
Void Hash_obj::set( ::String key,Dynamic value){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",34)
...
Dynamic Hash_obj::get( ::String key){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",38)
...
bool Hash_obj::exists( ::String key){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",42)
...
bool Hash_obj::remove( ::String key){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",46)
...
::String Hash_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",76)
...
;
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Hash.hx",86)
	s->b[s->b->length] = HX_CSTRING("}");
