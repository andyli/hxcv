...
int Bytes_obj::get( int pos){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",45)
...
Void Bytes_obj::set( int pos,int v){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",59)
		this->b[pos] = v;
	}
return null();
}
...
::String Bytes_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",203)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",228)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",229)
	if ((length > 0))
		a[(length - 1)] = 0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",230)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",250)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",251)
	::__hxcpp_bytes_of_string(a,s);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",252)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Bytes.hx",286)
