...
::haxe::io::Bytes Input_obj::readAll( Dynamic bufsize){
	...
	try{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",85)
		while(true){
			__SAFE_POINT
...
Void Input_obj::readFullBytes( ::haxe::io::Bytes s,int pos,int len){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",97)
		while((len > 0)){
			__SAFE_POINT
...
double Input_obj::readFloat( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",145)
...
double Input_obj::readDouble( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",159)
...
::cpp::CppInt32__ Input_obj::readInt32( ){
	...
	int ch4 = this->readByte();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",239)
...
::String Input_obj::readString( int len){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",243)
	::haxe::io::Bytes b = ::haxe::io::Bytes_obj::alloc(len);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",244)
	this->readFullBytes(b,0,len);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/haxe/io/Input.hx",248)
	return b->toString();
}
...
{
	hx::Static(_float_of_bytes) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("float_of_bytes"),2);
	hx::Static(_double_of_bytes) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("double_of_bytes"),2);
}
