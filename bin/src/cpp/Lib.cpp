...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",36)
...
Dynamic Lib_obj::loadLazy( Dynamic lib,Dynamic prim,int nargs){
	...
	try{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",46)
		return ::__loadprim(lib,prim,nargs);
	}
	catch(Dynamic __e){
		{
			Dynamic $t1 = __e;{
				...
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",48)
				switch( (int)(nargs)){
					case 0: {
