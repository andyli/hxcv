...
Array< ::String > Sys_obj::args( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",6)
	return ::__get_args();
}
...
Void Sys_obj::putEnv( ::String s,::String v){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",17)
...
Void Sys_obj::sleep( double seconds){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",21)
...
bool Sys_obj::setTimeLocale( ::String loc){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",25)
...
::String Sys_obj::getCwd( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",29)
...
Void Sys_obj::setCwd( ::String s){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",33)
...
::String Sys_obj::systemName( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",37)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",42)
	{
		...
		while((_g1 < _g)){
			...
			switch( (int)(arg.charCodeAt(i))){
				case 32: case 34: {
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",45)
					ok = false;
				}
				;break;
				case 0: case 13: case 10: {
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",47)
					arg = arg.substr(0,i);
				}
				;break;
			}
...
Void Sys_obj::exit( int code){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",64)
...
double Sys_obj::time( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",68)
...
double Sys_obj::cpuTime( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",72)
...
::String Sys_obj::executablePath( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Sys.hx",76)
...
void Sys_obj::__boot()
{
	hx::Static(get_env) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("get_env"),1);
	hx::Static(put_env) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("put_env"),2);
	hx::Static(_sleep) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_sleep"),1);
	hx::Static(set_time_locale) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("set_time_locale"),1);
	hx::Static(get_cwd) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("get_cwd"),0);
	hx::Static(set_cwd) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("set_cwd"),1);
	hx::Static(sys_string) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_string"),0);
	hx::Static(sys_command) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_command"),1);
	hx::Static(sys_exit) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_exit"),1);
	hx::Static(sys_time) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_time"),0);
	hx::Static(sys_cpu_time) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_cpu_time"),0);
	hx::Static(sys_exe_path) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_exe_path"),0);
	hx::Static(sys_env) = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_env"),0);
}
