...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",45)
	this->length = 0;
}
;
	return null();
...
Dynamic List_obj::first( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",81)
...
Dynamic List_obj::last( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",89)
...
bool List_obj::isEmpty( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",113)
	return ((this->h == null()));
}
...
Dynamic List_obj::iterator( ){
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			...
			Dynamic run(){
{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",156)
			...
			Dynamic run(){
{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",159)
					{
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/List.hx",153)
